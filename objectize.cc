...
EMSCRIPTEN_KEEPALIVE void doNoise3(int seed, double frequency, int octaves, float heightScale, int dims[3], float shifts[3], float offset, float *potential) {
  noise3(seed, frequency, octaves, heightScale, dims, shifts, offset, potential);
}
